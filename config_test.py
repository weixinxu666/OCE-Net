...
def parse_args():
    ...
    # parser.add_argument('--save', default='UNet_downsize2_vessel_seg_val_on_test', help='save name of experiment in args.outf directory')
    ...
    # parser.add_argument('--save', default='U_Net_apf_DNL_cbam_unary_downsize2', help='save name of experiment in args.outf directory')
    ...
    # parser.add_argument('--save', default='Dynamic_conv_K8_UNet_small', help='save name of experiment in args.outf directory')
    ...
    # parser.add_argument('--save', default='all_dc_att_apf', help='save name of experiment in args.outf directory')
    # parser.add_argument('--save', default='all_att_apf', help='save name of experiment in args.outf directory')
    # parser.add_argument('--save', default='all_fusion_', help='save name of experiment in args.outf directory')
    # parser.add_argument('--save', default='all_dc_att_apf', help='save name of experiment in args.outf directory')
    # parser.add_argument('--save', default='all_dfv2_att_apf', help='save name of experiment in args.outf directory')
    # parser.add_argument('--save', default='stare_sk_all_att_apf_fusion', help='save name of experiment in args.outf directory')
    # parser.add_argument('--save', default='drive_sk_all_att_apf_fusion', help='save name of experiment in args.outf directory')
    # parser.add_argument('--save', default='chasedb_sk_all_att_apf_fusion', help='save name of experiment in args.outf directory')
    ...
    parser.add_argument('--inside_FOV', default='all',
