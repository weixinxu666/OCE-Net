...
class Test():
    ...
    def save_segmentation_result(self):
        ...
        self.save_img_path = join(self.path_experiment,'result_img_thin')
...
if __name__ == '__main__':
    ...
    # net = models.Ladder_net.LadderNet(1,2, layers=3, filters=16).to(device)
    # net = models.UNetFamily.AttU_Net_small(1,2).to(device)
    # net = models.Dynamic_Gabor_UNet.U_Net(1,2).to(device)
    # net = models.UNetFamily.Dense_Unet(1,2,128).to(device)
